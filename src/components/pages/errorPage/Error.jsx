  ...
  return (
    <div className="hero min-h-screen bg-green-100">
      <div className="hero-content flex-col lg:flex-row">
        <img src={errorPic} className=" max-w-xs md:max-w-sm object-cover rounded-lg shadow-2xl" />
        <div className="ml-3 md:ml-0">
          <h1 className=" text-3xl lg:text-5xl font-bold">Sorry Something Went Wrong!</h1>
          <p className="py-2">
